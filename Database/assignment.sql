...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2022 at 04:55 PM
...
CREATE TABLE `master` (
  `id` int(11) NOT NULL,
  `type` text NOT NULL COMMENT 'plan or class',
...
CREATE TABLE `membership` (
  ...
  `membership_offer_name` text DEFAULT NULL,
...
(1, 'BEGINNER', 3, '', 1999.00, 0, 'N/A', '1', NULL, '2021-02-25 11:55:00', '2020-12-28 08:07:29');
